document.addEventListener('DOMContentLoaded', () => {
    ...
    if (contenedorTabla && tablaCuerpo) {
        ...
        inputBusqueda.setAttribute('placeholder', 'Buscar mantenimientos (equipo, problema, fecha)...');
    ...
    if (btnGuardar && tablaCuerpo) {
        btnGuardar.addEventListener('click', (e) => {
            ...
            if (!camposCompletos) {
                alert("Por favor, complete todos los campos para registrar el mantenimiento del equipo.");
                return;
            }
            ...
            alert("Registro de mantenimiento guardado con éxito.");
        });
    }
});
aaron